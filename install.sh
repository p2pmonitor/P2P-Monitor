...
cp "$SCRIPT_DIR/py/error_rules.py"    "$INSTALL_DIR/py/"
...
cp "$SCRIPT_DIR/py/launcher.py"       "$INSTALL_DIR/py/"
cp "$SCRIPT_DIR/py/relaunch.py"       "$INSTALL_DIR/py/"
cp "$SCRIPT_DIR/py/platform_ops.py"   "$INSTALL_DIR/py/"
cp "$SCRIPT_DIR/py/wom.py"            "$INSTALL_DIR/py/"
...
cp "$SCRIPT_DIR/ui/wom_goals.py"      "$INSTALL_DIR/ui/"
