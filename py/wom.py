...
DEFAULT_WOM_RATES = {
    ...
    "Prayer": {"xp_hr": 350000, "mode": "active", "label": "Dragon bones, Wilderness altar"},
    "Runecraft": {"xp_hr": 45000, "mode": "active", "label": "Guardians of the Rift"},
    "Construction": {"xp_hr": 135000, "mode": "active", "label": "Mahogany Homes, teak planks"},
    "Agility": {"xp_hr": 50000, "mode": "active", "label": "Course progression"},
    "Herblore": {"xp_hr": 180000, "mode": "active", "label": "Best available potions"},
    "Thieving": {"xp_hr": 100000, "mode": "active", "label": "Guards \u2192 gnomes \u2192 elves"},
    "Crafting": {"xp_hr": 180000, "mode": "active", "label": "Cutting rubies"},
    "Fletching": {"xp_hr": 160000, "mode": "active", "label": "Stringing longbows"},
    "Slayer": {"xp_hr": 35000, "mode": "active", "label": "General Slayer progression"},
    "Hunter": {"xp_hr": 70000, "mode": "mixed", "label": "Birdhouses \u2192 Herbiboar"},
    "Mining": {"xp_hr": 40000, "mode": "active", "label": "Motherlode Mine"},
    "Smithing": {"xp_hr": 250000, "mode": "active", "label": "Blast Furnace gold bars"},
    ...
    "Firemaking": {"xp_hr": 200000, "mode": "active", "label": "Wintertodt"},
    "Woodcutting": {"xp_hr": 55000, "mode": "active", "label": "Willows \u2192 redwoods"},
    "Farming": {"xp_hr": 60000, "mode": "passive", "label": "Hourly snape grass + best herb runs"},
    "Sailing": {"xp_hr": 50000, "mode": "experimental", "label": "Lonely salvaging, one hook"},
}
