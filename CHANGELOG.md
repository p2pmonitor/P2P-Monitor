...
- **Discord Alerts** — Bot Setup, a collapsible Bot Setup Instructions block, Webhooks (now always visible as its own card instead of a nested collapsible).
